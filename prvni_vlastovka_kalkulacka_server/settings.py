"""
Django settings for prvni_vlastovka_kalkulacka_server project.
...
SECRET_KEY = open(os.path.join(BASE_DIR, 'key.txt')).read()
...
ROOT_URLCONF = 'prvni_vlastovka_kalkulacka_server.urls'
